...
//    ss >> pt;
	...
	// ctp.pub_m1905
	std::string pubname = Application::instance()->getConfig().get_string("ctp.pub_depthmarket")+ task_data.InstrumentID;
	std::string lastname = Application::instance()->getConfig().get_string("ctp.last_depthmarket")+ task_data.InstrumentID;
	std::string listname = Application::instance()->getConfig().get_string("ctp.list_depthmarket")+ task_data.InstrumentID;
