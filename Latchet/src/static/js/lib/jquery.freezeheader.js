...
(function ($) {
    ...
    $.fn.freezeHeader = function (params) {
                    ...
                    if (obj.header.offset() != null) {
                        if (limiteAlcancado(obj, params)) {
                            ...
                            if (($(document).scrollTop() > obj.header.offset().top)) {
                                ...
                                obj.container.css("top", "0px");//, (obj.grid.find("tr:last").offset().top - obj.header.height()) + "px");
                            }
                            else {
        ...
        function cloneHeaderRow(obj) {
            obj.container.html('');
            obj.container.val('');
            var tabela = $('<table style="margin: 0 0;background:#fff;border-bottom:1px solid #333;"></table>');
            ...
            if (params && params.height !== undefined) {
                ...
                if(params.offset !== undefined){
                    obj.container.css("top", "0px");//, obj.scroller.offset().top + (params.offset.replace("px","") * 1) + "px");
                }
                else
                {
                    obj.container.css("top", "0px");//, obj.scroller.offset().top + "px");
                }
                
            obj.container.css("position", "absolute");
                
            } else if (params && params.scrollListenerEl!== undefined) { 
                obj.container.css("top", "0px");//, obj.scroller.find("thead > tr").innerHeight() + "px");
                obj.container.css("position", "absolute");
                obj.container.css("z-index", "2");
            } else if (params && params.offset !== undefined) {
                obj.container.css("top", "0px");//params.offset);
