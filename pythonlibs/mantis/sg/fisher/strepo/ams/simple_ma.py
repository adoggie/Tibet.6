...
code = '0600776'
code = '1002129'
logfile = 'z:/simple_ma_{}.log'.format(code)
log = open(logfile,'a+')
...
def strategy_ma( stk ):
    ...
    if b >= d and a < c and ma_buy_count == 0:
        ...
        amount = Strategy.Product.Stk_UseableAmt  # 获取可用资金数
        ...
        if cost <= amount * 0.1:
            ...
            order = OrderItem(code, 'B', num, last_price)
...
import mantis.sg.fisher.strepo.ams.simple_ma as module
